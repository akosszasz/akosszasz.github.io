<ul class="add-buttons">
    <li>
        <button id="" type="button" onclick="location.href='index.php#nocategory'" name="submit-single" class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored mdl-color--red-500" value="back">
...
$cikkek = mysqli_query($connGWP,"SELECT * FROM ".PREFIX."_content WHERE sectionID='999' ORDER BY timeCreated");
...
<?php
//$cikkek = mysqli_query($connGWP,"SELECT * FROM ".PREFIX."_content WHERE sectionID='$secID' ORDER BY kiemeltCikk DESC, timeCreated DESC");
