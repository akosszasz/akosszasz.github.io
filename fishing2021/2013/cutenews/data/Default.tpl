...
<table border="0" width="100%" cellpadding="0" cellspacing="2" bgcolor="#027702" style="border-bottom-width:1; border-bottom-color:rgb(0,0,0); border-bottom-style:solid;">
    <tr>
...
<table border="0" width="100%" cellpadding="0" cellspacing="2" bgcolor="#027702" style="border-bottom-width:1; border-bottom-color:rgb(0,0,0); border-bottom-style:solid;">
    <tr>
        ...
        <td width="20%" align="right"><b><font color="#fffffff">{date}</font></b></td>
    </tr>
</table>
