...
function auth() {
  ...
  return class_exists("Auth") && Auth::instance()->get_user() && Auth::instance()->get_user()->has("roles",ORM::factory("Role",array('name'=>'admin')));
}
 ...
 */
 $config['doc_root'] = rtrim(DOCROOT,"/"); // No end slash
